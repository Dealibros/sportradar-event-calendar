...
export default function EventForm({ sports, showModal, setShowModal }) {
  ...
  // Create new event. Add data into the database
  async function insertSport() {
    ...
    // Refresh page to show new data added
    window.location.reload();
  }
  // To close Modal after the event is created
  const handleClose = () => {
    setShowModal(false);
  };

  return (
    // If showModal is true the window will be shown as open
    showModal && (
            ...
            <div>
              ...
              <label htmlFor="sport-select">
                ...
                <select
                  ...
                  required
                >
                  <option value="Sports" disabled selected hidden>
                    Sports
                  </option>
                  {sports.map((sport) => (
              ...
              <button
                ...
                onClick={(event) => {
                  ...
                  insertSport(timeDate, theSport, teamOne, teamTwo);
                  window.location.reload();
                  handleClose();
                }}
              >
